//The sript may need to be run multiple times to cache some results
//2 to 3 times should do the trick.
...
var classifiersList = ["cart", "continuousNaiveBayes", "gmoMaxEnt", "minimumDistance", "naiveBayes", "perceptron", "randomForest", "winnow"];
...
for(var classifierName in classifiersList){
  ...
  print("errorMatrix validation", em,"accuracy", em.accuracy(), "kappa", em.kappa());
